...
{
	tlm_utils::simple_target_socket<target> t_socket;
	enum { size = 256 };
	int mem[256];
...
//	sc_in<bool>t_clk;
	...
	SC_CTOR(target) :t_socket("t_socket")
	{

		t_socket.register_b_transport(this, &target::b_transport); //b_transport(     this    ,pointer to memb. function)
	...
	//	std::cout << "data getting initialised at t_clk" << std::endl;
